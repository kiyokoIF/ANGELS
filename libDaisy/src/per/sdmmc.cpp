...
void HAL_SD_MspInit(SD_HandleTypeDef* sdHandle)
{
    ...
    if(sdHandle->Instance == SDMMC1)
    {
        ...
        /**SDMMC1 GPIO Configuration    
            PC12     ------> SDMMC1_CK  : NO PULL
            PC11     ------> SDMMC1_D3  : PULL UP
            PC10     ------> SDMMC1_D2  : PULL UP
            PD2      ------> SDMMC1_CMD : PULL UP
            PC9      ------> SDMMC1_D1  : PULL UP
            PC8      ------> SDMMC1_D0  : PULL UP
        */
        ...
        GPIO_InitStruct.Pull      = GPIO_NOPULL; /**< CHANGED TO INTERNAL PULLUP */
